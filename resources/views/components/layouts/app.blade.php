...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Net Zero Submission - Building a cleaner, healthier India through innovation, community participation, and sustainable waste management practices. Join our Zero Waste Movement led by Ajay Mehra.">
    ...
    <meta name="author" content="Ajay Mehra - Net Zero Submission">
    ...
    <meta property="og:title" content="{{ $title ?? 'Net Zero Submission - Creating a Cleaner India' }}">
    ...
    <meta property="og:site_name" content="Net Zero Submission">
    <meta property="og:locale" content="en_IN">

    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="{{ $title ?? 'Net Zero Submission - Creating a Cleaner India' }}">
    ...
    <title>{{ $title ?? 'Net Zero Submission - Creating a Cleaner, Greener India' }}</title>
