<!-- ================= FOOTER ================= -->
<footer class="bg-gradient-to-b from-gray-900 to-gray-950 text-gray-300 relative overflow-hidden">
    <!-- Background Pattern -->
    <div class="absolute inset-0 opacity-5">
        <div class="absolute top-0 left-1/4 w-96 h-96 bg-green-500 rounded-full filter blur-3xl"></div>
        <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-green-600 rounded-full filter blur-3xl"></div>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li class="flex items-start gap-2">
                        ...
                        <span class="text-gray-400">SS Bin Implementation</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-green-500 mt-1">•</span>
                        <span class="text-gray-400">Zero Waste Movement</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-green-500 mt-1">•</span>
                        <span class="text-gray-400">River Conservation</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-green-500 mt-1">•</span>
                        <span class="text-gray-400">Luminflex Lights</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-green-500 mt-1">•</span>
                        <span class="text-gray-400">Event Management</span>
                    </li>
                </ul>
            </div>
                ...
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="tel:+917016916505" class="text-gray-300 hover:text-green-400 transition-colors">+91 7016916505</a>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
                        <div class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            <div class="text-gray-500 text-xs mb-1">Location</div>
                            <span class="text-gray-300">Indore, India</span>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-6 text-sm">
                <a
                    ...
                    class="text-gray-400 hover:text-green-400 hover:underline transition">
                    Powered By <span class="text-green-600 font-bold">Techonika</span>
                </a>
        ...
        <div class="mt-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-gray-800/50 rounded-full text-xs text-gray-500">
                <span>Made with</span>
